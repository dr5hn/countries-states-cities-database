...
Comprehensive geographical database published in 11 formats (JSON, MySQL, PostgreSQL, SQLite, SQL Server, MongoDB, XML, YAML, CSV, GeoJSON, TOON). Updated monthly. Free under [ODbL](LICENSE).
...
2. Edit files under `contributions/cities/`, `contributions/states/`, or `contributions/countries/`.
