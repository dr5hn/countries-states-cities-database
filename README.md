...
| Country+States             | :white_check_mark: | NA                 | NA                 | NA                 | NA                 | :white_check_mark: | NA                 |
| Country+Cities             | :white_check_mark: | NA                 | NA                 | NA                 | NA                 | :white_check_mark: | NA                 |
| State+Cities               | :white_check_mark: | NA                 | NA                 | NA                 | NA                 | :white_check_mark: | NA                 |
| Country+State+Cities/World | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | NA                 | :white_check_mark: | NA                 |
