...
/**
 * @ORM\Table(name="states", options={"collate":"utf8mb4_unicode_ci", "charset":"utf8mb4", "engine":"InnoDB", "ROW_FORMAT":"COMPACT"})
...
class State
{
    ...
    /**
     * @ORM\Column(type="string", name="fips_code", nullable=true, length=255, options={"default"=NULL, "collation":"utf8mb4_unicode_ci"})
     */
    private $fipsCode;

    /**
     * @ORM\Column(type="string", name="iso2", length=10, options={"default"=NULL, "collation":"utf8mb4_unicode_ci"})
     */
    private $iso2;

    /**
     * @ORM\Column(type="string", name="type", length=191, nullable=true, options={"default"=NULL, "collation":"utf8mb4_unicode_ci"})
     */
    private $type;
     ...
     */
    public function setFipsCode($fipsCode): void
    {
